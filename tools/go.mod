// Module tools isolates build-time tool dependencies from the shipping
// module's dependency graph. See docs/plans/2026-08-18-repo-foundation.md.
module github.com/knograph/kno/tools
